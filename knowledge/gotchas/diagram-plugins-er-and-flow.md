...
- **BPMN proper:** impossible in mermaid, and no dsh plugin does it. Model a BPMN-ish process as
  `flowchart TD` with lanes as `subgraph`; anything that must be real BPMN 2.0 is out of this repo's scope.
